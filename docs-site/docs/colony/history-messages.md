...
History is a flat list of colony statistics and records. Arrow up and down to move through it. Type ahead to jump to an entry by name. Home and End jump to the ends of the list. For general list navigation, see [navigating menus](../concepts/navigating-menus.md).
...
For what specific event letters mean and how to respond to them, the [Events page on the RimWorld wiki](https://rimworldwiki.com/wiki/Events) covers individual events in depth.
